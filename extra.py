...
# Spy class
class User:
    def __init__(self, name, age, rating, stat):
        self.name = name
        self.age = age
        self.rating = rating
        self.online = stat
        self.stat_mess = ['Behold, here comes the terror', 'Are u a spy?']
...
def send_message():
    ...
    try:
        print colored("\n...Loading...",attrs=['blink'])
        Steganography.encode(image_name, "output.jpg", sec_message)
    except IOError:
